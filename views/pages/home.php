                ...
                <div class="offcanvas-menu">
                    <ul>
                        ...
                        <li>
                            ...
                            <ul class="mobile-sub-menu">
                                <li>
                                    <a href="product-details-default.php">Products</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                                ...
                                <div class="banner-single-item banner-style-2 banner-animation img-responsive"
                                    ...
                                    <div class="content">
                                        <h4 class="title">Kitchen <br>
                                            utensils</h4>
                                        <a href="product-details-default.php" class="link-text"><span>Shop
                                                now</span></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-sm-6 mb-6">
                                <div class="banner-single-item banner-style-2 banner-animation img-responsive"
                                    ...
                                    <div class="content">
                                        <h4>Interior <br>
                                            lighting</h4>
                                        <a href="product-details-default.php"><span>Shop now</span></a>
                                    </div>
                                </div>
                            </div>
                            <!-- End Banner Single Item -->
